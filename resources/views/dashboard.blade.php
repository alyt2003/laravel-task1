        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">Registered users</p>
                </div>
        ...
        <div class="rounded-2xl border border-gray-100 bg-white shadow-sm">
            <div class="flex flex-col gap-4 border-b border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <a href="{{ route('admin.users.create') }}" class="inline-flex flex-shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 transition-colors">
                    ...
                    <table class="min-w-full divide-y divide-gray-100 text-sm">
                        ...
                        <tbody id="usersTableBody" class="divide-y divide-gray-100">
                            @foreach ($users as $user)
                                <tr class="user-row hover:bg-gray-50 transition-colors" data-search="{{ strtolower($user->name.' '.$user->email) }}">
